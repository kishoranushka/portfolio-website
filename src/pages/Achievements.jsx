    ...
    <>
      <div className="mt-16   max-w-screen-xl md:mx-auto mx-3">
        <div className="photos   ">
          <h1 className="lg:text-6xl text-center  md:text-left text-4xl md:mb-10 mb-5  font-bold text-gray-800 ">
          ...
          <h1 className="lg:text-6xl text-4xl text-center md:text-left mb-10  font-bold text-gray-800 ">
          ...
          <h1 className="lg:text-6xl text-center md:text-left text-4xl mb-10  font-bold text-gray-800 ">
